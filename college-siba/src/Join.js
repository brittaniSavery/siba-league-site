...
import { Button, FormGroup, ControlLabel, FormControl, Modal, Glyphicon } from 'react-bootstrap';
    ...
    render() {
        return (
            <section className="container">
                ...
                <p>Intersting in joining the SIBA as the coach of your own college basketball team? Fill out the form below and the commissioner
                ...
                <form onSubmit={(e) => this.handleSubmit(e)}>
                    ...
                    <Button type="submit" disabled={this.state.emailSending}>Submit</Button>
                    <span style={{display: !this.state.emailSending ? 'none' : null }}><Glyphicon glyph="hourglass" /></span>
                </form>
                ...
                <Modal show={this.state.emailSent}>
                    ...
                    <Modal.Body>
                        <p>We greatly appreciate your interst in the SICBA. An email has been sent to the commissioner and 
                            you should be hearing a response within a couple of days.</p>
                    </Modal.Body>
                    <Modal.Footer>
