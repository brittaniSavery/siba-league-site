...
export const About = () => (
    <section className="container">
        ...
        <h2>The SIBA</h2>
        <p>
            The Simulation International College Basketball Assoication (SICBA for short) was the combined efforts of
...
export const Rules = () => (
    <section className="container">
        ...
        <section>
            ...
            <p>The Simulation Internet College Basketball Association is a league where you get to coach your favorite team and also enter the league as a 
                rookie coach with a lower teir team "20 prestige rating and lower" and try to move up the ranks of coaching.</p>

            <p>Simulations will occur three times a week. If you're going to be unable to access a computer for a few days for whatever reason please let the commissioner know. 
                You are free to ask anyone in the league to act as a proxy for your team if you will be away for an extended period of time. 
                Missing a sim or 2 here and there isn’t a big deal.</p>

            <p>Each coach has a personality as well as skills in their coaching ability. There are 5 different categories for a coach's skills: offense, defense, 
                scouting, recruiting, and player development. Each category has a minimum of 10 points and a maximum of 100 points.
            </p>
        </section>
        ...
        <section>
            ...
            <p>If your are coaching three teams the coaches names need to be different. There is a tier level for each coach and this level will be posted at the beginning of 
                every season. Coach 1 teams will be considered ranked 1-60; Coach 2 teams will be considered 61-206; Coach 3 teams will be considered 207-352.</p>

            <p>The following information is required to set up a coach:</p>
            <ul>
                <li>Login PIN (4-digit number)</li>
                <li>Full Name for Owner</li>
                <li>Details for Coach
                    <ul>
                        <li>Full name</li>
...
export const Home = () => (
    <section className="container">
        ...
        <p>The Simulation International College Basketball Assoication (SICBA) is a fictional basketball simulation league using the Draft Day Sports: College Basketball program by Wolverine Studios. Colleges and coaches from around the world all plan, recruit, train, and play in order to take home the coveted prize of the SICBA Championship.
            Will your team be number 1 in the league? <Link to="/info/join">Join SICBA</Link> to claim your spot in the playoffs!
        </p>
        <h2>Updates</h2>
        <h4>February 10, 2019</h4>
        <p>The SICBA is officially open! Feel free to contact the commissioner with the <Link to="/info/join">Join</Link> form as well as check out the Rules to get a 
        better idea on how the league will work. Also, remember to purcahse your copy of <a href="https://www.wolverinestudios.com/draft-day-sports-college-basketball-simulation/"><b>Draft Day Sports: College Basketball 2019</b></a>. 
...
export const SicbaStandings = () => <CommingSoon header="SICBA Division Standings" />
